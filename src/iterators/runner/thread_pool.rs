...
use iterators::runner::api::Configuration;
use deque;
use deque::{Worker, Stealer, Stolen};
use iterators::runner::job::{JobRef, JobMode};
use iterators::runner::latch::{Latch, LockLatch, SpinLatch};
#[allow(unused_imports)]
use iterators::runner::log::Event::*;
use rand::{self, Rng};
use std::cell::Cell;
...
use std::mem;
use iterators::runner::unwind;
use iterators::runner::util::leak;
use num_cpus;
