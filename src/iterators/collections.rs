use iterators::iterators::{IntoParallelIterator, ParallelIterator};
use iterators::chain::ChainIter;
use iterators::slice::SliceIter;
use iterators::slice_mut::SliceIterMut;
use iterators::vec::VecIter;
